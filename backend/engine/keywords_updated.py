...
KEYWORD_PATTERNS = [
    ...
    # Crisis — extended (indirect & passive suicidal phrases missed by VADER)
    (r"\b(noose|rope around my neck|tied the rope|loaded the gun|took the pills)\b", "crisis", "severe"),
    (r"\b(pleasekillme|please kill me|release me from|ready to die|want it to be over)\b", "crisis", "severe"),
    (r"(wish death would come|death would be better|hope someone kills me)", "crisis", "severe"),
    (r"\b(said goodbye|goodbye everyone|last post|final note|suicide note)\b", "crisis", "severe"),
    (r"\b(contemplating suicide|thinking about suicide|planning to end|end it all|end it tonight)\b", "crisis", "severe"),
    (r"(take my own life|take my ow life|own my life to end|easier to die)", "crisis", "severe"),
    (r"\b(self mutilation|cutting myself|burn myself|overdose|hang myself)\b", "crisis", "severe"),
    (r"(fantasized about dying|fantasized about death|thought about ending)", "crisis", "severe"),
    (r"\b(why do people need us to stay alive|do not want to exist|stop existing)\b", "crisis", "severe"),
    (r"(i want to go|i want out|just want this to be over|can't take it anymore and want to die)", "crisis", "severe"),
